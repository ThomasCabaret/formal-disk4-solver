...
def build_k4_map() -> PlanarMap:
    """Return the fixed K4 contact map with one central and three peripheral pieces."""

    central = PieceSpec("C", ("I01", "I02", "I12"), False, "none")
    peripheral = (
        PieceSpec("P0", ("I02", "I01", "O01", "O02"), True, "arc"),
        PieceSpec("P1", ("I01", "I12", "O12", "O01"), True, "arc"),
        PieceSpec("P2", ("I12", "I02", "O02", "O12"), True, "arc"),
    )
